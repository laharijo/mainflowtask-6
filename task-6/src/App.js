...
const App = () => {
  ...
  const submitHandler = (e) => {
    ...
    axios
      .get(
        `https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=${apiKey}&tags=${search}&text=${search}&tag_mode=all&sort=relevance&per_page=24&format=json&nojsoncallback=1`
      )
      .then((response) => {
